...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><span>DeskSavy-</span>Employee Record Portal</h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
      ...
      <div class="clr"></div>
       <center>
           ...
           <form action="" method="post">
               <tr> <lable><h3>Enter Id- </h3></lable><input  type="number" name="t1" min="1"/></tr>
               <tr> <input style="background-color: red; border-bottom-left-radius: 2px" type="submit" value="Enter"/></tr>
           </form>
</script>
