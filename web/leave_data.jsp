...
out.println("</tr>");
   ...
   out.println("<tr bgcolor=#DFF5E1 height=30px><td align=center>"+id+"</td><td align=center>"+gender+"</td><td align=center>"+phone+"</td><td align=center>"+course+"</td><td align=center><a href=delete?id="+name+">Delete</a></td>");
out.println("</tr>");          
