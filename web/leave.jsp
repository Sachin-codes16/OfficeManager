...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>DeskSavvy-</span>Leave Portal</a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
     ...
     <center>
         <div style="width: 600px;height: 300px;background-color: white;">
            ...
            <fieldset style=" border: 3px solid black; border-radius: 13px" width="100px" height="400px">
                <table width="80px" >
                    <br></br>
                    <tr height="30px"><td><h3>Subject</h3></td><td width="20px"></td><td><input type="text" name="t1" style="height: 20px"></td></tr>
                    <tr height="30px"><td><h3> Message</h3></td><td width="20px"></td><td><textarea name="t2" rows="10" ></textarea></td></tr>
                                    
                    <tr height="30px"></tr><tr height="30px"><td><input type="submit" value="Send"style="width:90px;height: 30px ; border: 3px solid black; border-radius: 13px ;  background-color:lightskyblue;"> </td><td width="20px"></td><td><input type="reset" value="Clear" style="width: 90px ;height: 30px; border: 3px solid black; border-radius: 13px ; background-color: indianred;"></td></tr>
